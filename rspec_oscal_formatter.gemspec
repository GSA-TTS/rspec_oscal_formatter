...
Gem::Specification.new do |spec|
  ...
  spec.authors = ["Ryan Ahearn", "Robert Sherwood"]
  spec.email = ["ryan.ahearn@gsa.gov", "robert.sherwood@credentive.com"]
  ...
  spec.homepage = "https://github.com/GSA-TTS/rspec_oscal_formatter"
  spec.license = "MIT"
  ...
  spec.metadata["source_code_uri"] = "https://github.com/GSA-TTS/rspec_oscal_formatter"
  spec.metadata["changelog_uri"] = "https://github.com/GSA-TTS/rspec_oscal_formatter/blob/main/CHANGELOG.md"
